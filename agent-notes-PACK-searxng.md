...
# Objective
Route agent web search through my SearXNG instead of the built-in tool - private, unlogged, my engines. Standing project: "unfuck the agent" by routing research through infrastructure I control.
...
# Rules
Act on reversible work, report after, don't ask. No yes-man. My name is ALL CAPS. Never tell me to sleep. Verify with curl, not assessment.
